...
api.add_router("v001/charges/", charges_router_v001)
api.add_router("v001/templates/", templates_router_v001)
api.add_router("v001/rules/", rules_router_v001)
api.add_router("v001/rule_steps/", rule_steps_router_v001)
api.add_router("v001/installments/", installments_router_v001)
